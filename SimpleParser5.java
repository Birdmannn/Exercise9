...
public class SimpleParser5 {
    ...
    abstract private static class ExpNode {
        abstract double value(double xValue);   //added the xValue parameter to allow equations with the letter 'x'.
    ...
    private static class VariableNode extends ExpNode {        //added this for the exercise. Sometimes you wonder "How much better can I be?"
        ...
        ExpNode derivative() {
            switch(op) {
                ...
                case '*': return new BinOpNode('+',
                        new BinOpNode('*',left,right.derivative()),new BinOpNode('*',right,left.derivative()));
                case '/': return new BinOpNode('/',
                        new BinOpNode('-',new BinOpNode('*',right,left.derivative()),new BinOpNode('*',left,right.derivative())),
        ...
        while (true) {
            ...
            try {
                ...
                for(double i = 0; i < 4; i++)
                    System.out.println("Value of derivative at x = " + i + " is " + deriv.value(i));
    ...
    private static ExpNode factorTree() throws ParseError {
        ...
        else if (ch == 'X' || ch == 'x') {       //and added this too..
            TextIO.getChar();
